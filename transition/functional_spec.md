...
to Earth. They began by scanning the welcome QR code. The station indicated it
was currently in standby mode.
...
2.10.x Standalone Training Mode
-------------------------------

This section is identical to the **Training Mode** section above. 
