...
%%END\_SECTION%% EthernetStaticIp

%%BEGIN\_SECTION%% Wifi

8a. TODO Comment out the wlan0 lines and replace with the following, noting to replace "$WIFI\_SSID" and the others with their actual values:

DO NOT DO THIS!!!! IT will make boot up very slow!
<pre>
...
Instead leave the default alone and open /etc/wsa TODO
...
4. Modify Apache init script to create directory in /var/log on tmpfs:
